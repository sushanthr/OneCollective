  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        fontFamily: 'Manrope',
        textTheme: TextTheme(
          headline1: TextStyle(fontSize: 46.0, fontWeight: FontWeight.w800, fontFamily: 'Manrope', color: HexColor.fromHex("5151c6")),
          headline2: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, fontFamily: 'Manrope', color: HexColor.fromHex("5151c6")),
          bodyText1: TextStyle(fontSize: 14.0, fontFamily: 'Manrope', color: HexColor.fromHex("5151c6")),
        ),
      ),
